...
public class UserListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (u.sex) {
            case MAN: ivUserpic.setImageResource(R.drawable.boy); break;
            case WOMAN: ivUserpic.setImageResource(R.drawable.girl); break;
            case UFO: ivUserpic.setImageResource(R.drawable.ufo); break;
        }
